defmodule ProjectTides.Communications.BSP.Gupshup.Worker do
  use Oban.Worker,
    queue: :gupshup,
    max_attempts: 3,
    priority: 0

  alias ProjectTides.Communications.BSP.Gupshup.ApiClient
  alias ProjectTides.{Messages, Messages.Message}

  @rate_name Application.fetch_env!(:project_tides, :bsp_id)
  @rate_limit Application.fetch_env!(:project_tides, :bsp_limit)
