defmodule ProjectTidesWeb.Schema.MessageMediaTypes do
  ...
  object :message_media_queries do
    ...
    field :message_media, :message_media_result do
      arg(:id, non_null(:id))
      resolve(&Resolvers.MessageMedia.message_media/3)
    end
  ...
  object :message_media_mutations do
    field :create_message_media, :message_media_result do
      ...
      resolve(&Resolvers.MessageMedia.create_message_media/3)
    end

    field :update_message_media, :message_media_result do
      arg(:id, non_null(:id))
      arg(:input, :message_media_input)
      resolve(&Resolvers.MessageMedia.update_message_media/3)
    end

    field :delete_message_media, :message_media_result do
      arg(:id, non_null(:id))
      resolve(&Resolvers.MessageMedia.delete_message_media/3)
    end
  end
end
